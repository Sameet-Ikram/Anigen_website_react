...
const MyThreeScene = () => {
  ...
  useEffect(async() => {
    ...
    renderer.setSize(600, 400);
     ...
     // Load the background
     loadBackground('https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/4k/blue_photo_studio_4k.hdr', renderer).then((envMap) => {
  ...
  return (
  <>
  <canvas id="canvas" ref={canvasRef} style={{width: '600px',height: '400px'}}/>
  </>
  );
};
